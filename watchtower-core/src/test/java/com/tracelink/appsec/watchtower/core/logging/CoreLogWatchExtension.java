 ...
 * this class in the watchtower-test module to support the same features in watchtower modules.
 * 
 * @author csmith
 *
 */
public class CoreLogWatchExtension implements BeforeEachCallback, AfterEachCallback {

	private ListAppender<ILoggingEvent> listAppender = new ListAppender<>();
	private Logger logger = null;

	private CoreLogWatchExtension(String classLogger) {
		if (classLogger != null) {
	 ...
	 * 
	 * @return a {@linkplain CoreLogWatchExtension} that does not track logs
	 */
	public static CoreLogWatchExtension none() {
		return new CoreLogWatchExtension(null);
	}
	 ...
	 * @return a {@linkplain CoreLogWatchExtension} that tracks logs for the given class
	 */
	public static CoreLogWatchExtension forClass(Class<?> clazz) {
		return new CoreLogWatchExtension(clazz.getName());
	}
	 ...
	 * message.
	 * 
	 * @return a {@linkplain CoreLogWatchExtension} that tracks logs for all loggers
	 */
	public static CoreLogWatchExtension root() {
		return new CoreLogWatchExtension(Logger.ROOT_LOGGER_NAME);
	}
	 ...
	 */
	public CoreLogWatchExtension withLevel(Level level) {

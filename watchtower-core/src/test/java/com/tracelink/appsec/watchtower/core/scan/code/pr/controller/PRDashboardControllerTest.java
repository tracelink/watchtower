...
public class PRDashboardControllerTest {
	...
	public void testGetDashboard() throws Exception {
		...
		BDDMockito.when(mockMetricsService.getScanCount(ScanType.PULL_REQUEST)).thenReturn(3L);
		BDDMockito.when(mockMetricsService.getViolationCount(ScanType.PULL_REQUEST)).thenReturn(5L);

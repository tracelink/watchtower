...
public class UploadDashboardControllerTest {
	...
	public void testGetDashboard() throws Exception {
		...
		BDDMockito.when(mockMetricsService.getScanCount(CodeScanType.UPLOAD)).thenReturn(3L);
		BDDMockito.when(mockMetricsService.getViolationCount(CodeScanType.UPLOAD)).thenReturn(5L);
		BDDMockito.when(mockMetricsService.getAverageScanTimeString(CodeScanType.UPLOAD))
				.thenReturn("7");

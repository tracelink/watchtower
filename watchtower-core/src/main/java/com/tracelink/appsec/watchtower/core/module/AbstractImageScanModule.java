 ...
 * @author mcool
 */
public abstract class AbstractImageScanModule extends AbstractModule {
	private static final Logger LOG = LoggerFactory.getLogger(AbstractImageScanModule.class);
	...
	/**
	 * The implementation of an {@link IImageScanner}.
	 * <p>
	 ...
	 */
	public abstract IImageScanner getScanner();

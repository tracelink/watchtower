...
public abstract class AbstractProcessor {
	...
	private List<CodeScanReport> reports = new ArrayList<CodeScanReport>();
	 ...
	 */
	protected void addReport(CodeScanReport report) {
		reports.add(report);
	}

	public List<CodeScanReport> getReports() {
		return this.reports;
	}
	 ...
	 */
	protected abstract void processFile(Callable<CodeScanReport> callable);

...
public interface IScmApi {
	...
	/**
	 * Test that this entity is configured correctly to connect to its SCM
	 * 
	 * @throws ApiIntegrationException if the entity cannot connect to the SCM or does not have the
	 *                                 correct access
	 */
